...
\newcommand{\jurynameE}{Michel Darmon}
\newcommand{\juryadressE}{Directeur de recherche, CEA LIST (DISC/LSMA)}
\newcommand{\juryroleE}{Directeur de thèse}

%%% Membre n°6 (Co-directeur de thèse) / Member n°6 (Thesis co-supervisor)
\newcommand{\jurynameF}{Gilles Lebeau}
\newcommand{\juryadressF}{Professeur, Université de Nice (Laboratoire J. A. Dieudonné)}
