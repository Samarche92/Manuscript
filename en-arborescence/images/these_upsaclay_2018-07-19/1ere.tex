...
\newcommand{\juryadressA}{Directrice de recherche, HDR, CNRS (LMA), Marseille}
\newcommand{\juryroleA}{Examinatrice}

%%% Membre n°2 (Rapporteur) / Member n°2 (President)
\newcommand{\jurynameB}{Olivier Lafitte}
\newcommand{\juryadressB}{Professeur des Universités, Université Paris 13, Paris}
...
\newcommand{\juryadressD}{Directeur de Recherche CEA, HDR, CEA DAM et CMLA, Arpajon, ENS Cachan}
\newcommand{\juryroleD}{Examinateur}

%%% Membre n°5 (Examinateur) / Member n°5 (President)
\newcommand{\jurynameE}{Larissa Fradkin}
\newcommand{\juryadressE}{Professeur émérite, London South Bank University, UK}
