...
\begin{textblock}{10.3}(5.4,3)
	...
	%% Jury
	\begin{flushleft}
		\small Thèse dirigée par Michel Darmon, expert CEA, HDR et co-dirigée par Gilles Lebeau, Professeur à l'Université de Nice Sophia Antipolis (Laboratoire J. A. Dieudonné) et membre de l'Académie des Sciences.\\
		~\\
