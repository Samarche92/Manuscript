...
\newcommand{\NNT}{2019SACLS2793} 															%% Numéro National de Thèse (donnée par la bibliothèque à la suite du 1er dépôt)/ National Thesis Number (given by the Library after the first deposit)
...
\newcommand{\PhDspeciality}{Physique} 										%% Spécialité de doctorat / Speciality 
...
\newcommand{\juryroleI}{Président du jury}
