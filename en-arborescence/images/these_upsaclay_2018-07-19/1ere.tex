...
%%% Membre n°6 (Examinateur) / Member n°6(President)
\newcommand{\jurynameF}{Jean-Michel BERNARD}
\newcommand{\juryadressF}{Expert senior CEA, HDR, CEA DAM(CMLA), ENS Cachan}
\newcommand{\juryroleF}{Examinateur}

%%% Membre n°7 (Directeur de thèse) / Member n°7 (Thesis supervisor)
\newcommand{\jurynameG}{Michel Darmon}
\newcommand{\juryadressG}{Expert CEA HDR, CEA LIST (DISC/LSMA)}
\newcommand{\juryroleG}{Directeur de thèse}

%%% Membre n°8 (Co-directeur de thèse) / Member n°8 (Thesis co-supervisor)
\newcommand{\jurynameH}{Gilles Lebeau}
\newcommand{\juryadressH}{Professeur, Université de Nice Sophia-Antipolis (Laboratoire J. A. Dieudonné)}
\newcommand{\juryroleH}{Co-directeur de thèse}

%%% Membre n°9 (Invité) / Member n°9 (Guest)
\newcommand{\jurynameI}{Loïc De Roumilly}
\newcommand{\juryadressI}{Ingénieur de recherche EDF}
