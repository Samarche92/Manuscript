...
\centering
	...
	\draw[thick, color = black]  (0,0) -- (8,0) node[midway,below] {($F_1$) bottom free surface};
	
	\draw[thick, color = black]  (0,0) -- (-2.39,6.5778) node[midway,below,sloped] {($F_2$) top free surface};
