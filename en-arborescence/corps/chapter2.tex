...
The Fourier transform is also applied to the potential velocity's normal derivative on the face of each wedge
\begin{align}
\mathcal{F}(x_j \mapsto v_j^0 (x_j,0))(\xi)
\end{align}
...
v^0_{\rm inc}(x_2,0) & =   \dfrac{1}{2} \, e^{i \, x_2 \cos (\varphi - \theta_{\rm inc} )} .
\end{align}
\end{subequations}
