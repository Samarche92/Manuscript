...
In chapter \ref{chap-acoustic}, the \acrfull{sf} method is developed as a first step for the simpler case of an acoustic wave scattered by a soft (Dirichlet boundary conditions) or hard (Neumann boundary conditions) wedge. A \acrshort{gtd} diffraction coefficient is obtained semi-analytically for both boundary types and it is successfully compared to the corresponding exact solutions given by Sommerfeld.

Chapter \ref{chap-2D} deals with the 2D of an elastic wave scattered by a stress-free wedge.