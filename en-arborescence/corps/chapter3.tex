...
%\centering
%    \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure9a.pdf}
%        \caption{Diffracted and incident L waves}
%    \end{subfigure}  
%    \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure9b.pdf}
%        \caption{Diffracted T wave and incident L wave}
%     \end{subfigure} \\   
%     \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure9c.pdf}
%        \caption{Diffracted L wave and incident T wave}
%    \end{subfigure}
%    \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure9d.pdf}
%        \caption{Diffracted and incident T waves}
%     \end{subfigure}
...
%\centering
%    \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure10a.pdf}
%        \caption{Incident L wave, $t=5ms$.}
%        \label{snapLL}
%    \end{subfigure}  
%    ~
%     \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure10b.pdf}
...
%\centering
%    \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure11a.pdf}
%        \caption{Diffracted and incident L waves. $r=25,6 \rm mm$.}
%        \label{DLL}
%    \end{subfigure}  
%    \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure11b.pdf}
%        \caption{Diffracted T wave and incident L wave. $r=13,9 \rm mm$.}
%        \label{DLT}
%     \end{subfigure}   
%     \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure11c.pdf}
%        \caption{Diffracted L wave and incident T wave. $r=36,5 \rm mm$.}
%        \label{DTL}
%    \end{subfigure}
%    \begin{subfigure}[b]{0.44\textwidth}
%        \includegraphics[width=\textwidth]{Figure11d.pdf}
