...
The "acoustic limit" of the 3D elastic code is thus validated for wedge angles lower and higher than $\pi$. This shows that the terms of the spectral functions that correspond to the contribution of L waves are computed correctly.
