...
&+\frac{i}{4\pi} \int_{C_0}\tilde{\nu}_T^2 e^{i\nuti_T R\cos\delta\cos(\lambda+t\theta)}\mathbf{ P_T}(\lambda,t)\Sigma_1(\tilde{\nu}_T\cos\lambda) \, d\lambda
\end{split}
\label{C4:v1C0evan}
\end{equation}
...
%\begin{subfigure}[b]{0.45\textwidth}
	...
	\draw[thin] (-2.5,0)  -- (3.7,0) node[above]{$\lambda_1$};
