...
\label{C4:defDp}
\end{equation}
In the case where $\nuti_L \in \mathbb{R}$, \eqref{C4:GaussDM} is valid for $V \in \mathbb{C}^3, \, z\in \mathbb{C} \backslash  \rbrack - \infty, -\nuti_L \rbrack , \,  z \notin \{\tilde{\nu}_L,\tilde{\nu}_T \}, \, \mbox{Im} z \geq 0, \, \xi \in \Omega_*^+, \, \mbox{Im} \xi <0 $ and in the case where $\nuti_L \in i\mathbb{R}$, \eqref{C4:GaussDM} is valid for $ z\in \mathbb{C} \backslash ( \, \rbrack - \infty, -\nuti_T \rbrack \cup \lbrack \nuti_L,+i\infty \lbrack \,), \,  z \notin \{\tilde{\nu}_L,\tilde{\nu}_T \}, \, \mbox{Im} z \geq 0$.
