...
In the case where $\varphi=\pi$, the wedge degenerates into an infinite plane and there is no edge diffracted wave. The regular part of the spectral functions, which is the part of the solution corresponding to the diffraction phenomena, vanishes and we should have, for $j=1,2$ :
\begin{equation}
